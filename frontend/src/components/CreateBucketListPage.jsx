    ...
    return (
        ...
        <div className="w-full flex flex-col h-screen bg-customBg">
            ...
            <main
                ...
                <div
                    className="mx-auto my-auto border-black border-2 w-72 rounded-xl bg-white sm:w-96 lg:h-60 lg:w-[30rem]">
                    <div className="flex mr-6 items-center rounded-xl rounded-b mb-3 font-bold text-lg sm:text-xl">
                        <img src="/png100px/es.png"
                             style={{borderRadius: '0.6rem 0 2rem 0', borderBottomRightRadius: '50%'}}
                             className="bg-customPurple size-12" alt="Flag"/>
                        <h3 className="ml-3 line-clamp-1 text-ellipsis">Water Action in Spain</h3>
                    </div>
                    <h4 className="mx-6 mb-3 text-ellipsis line-clamp-2 text-sm sm:line-clamp-3 sm:text-base">
                        Surfing in Spain and exploring while seeing whales and sharks Surfing in Spain and exploring
                        while seeing whales and sharks</h4>
                    <hr className="mb-3 mx-4"></hr>
                    <div className="flex justify-between mb-3 items-center">
                        <button className="ml-6 rounded-lg h-8 hover:text-customPurple">
            ...
            <div
                ...
                <button className="">
                    <FaMapMarkedAlt className="size-7 sm:size-8"></FaMapMarkedAlt>
                </button>
                ...
                <button className="">
                    <FaUserFriends className="size-7 sm:size-8"></FaUserFriends>
                </button>
                <button className="">
                    <MdPhotoCamera className="size-7 sm:size-8"></MdPhotoCamera>
                </button>
