...
function EditBucketListItem() {
    ...
    return (
        ...
        <div className="w-full flex flex-col h-screen bg-customBg">
            ...
            <div className="flex-1 flex flex-col justify-center mx-auto w-full md:w-[40rem]">
                <Formik
                    ...
                    onSubmit={async(values) => {
                        ...
                        if (Object.keys(updatedFields).length === 0) {
                            ...
                            *⠀⠀⠀⠀⠀⠀⢀⣀⣀⣀⣤⣤⣤⣤⣤⣤⣤⣤⣤⣤⣤⣤⣤⣀⣀⠀⠀⠀⠀⠀
                            ...
                            ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠉⠁⠀⠀⠀⠀⠀⠀
                            */
                            const res = await onSubmitEdit(_id, values);
                ...
                >
                    {({handleSubmit}) => (
                        <Form onSubmit={handleSubmit} className="flex flex-col w-full gap-2">
                            ...
                            <div className="flex justify-between mx-4 sm:gap-5">
                                <div className="flex flex-col w-2/5 sm:w-1/2">
                                ...
                                <div className="flex flex-col w-2/5 sm:w-1/4">
                                    <label>Date</label>
                                    <Field
                                        name="date"
                                        type="date"
                            ...
                            <div className="flex justify-between mx-4 gap-2">
                                <div className="relative flex flex-col w-2/5 sm:w-1/4">
                                    <label>Budget</label>
                                    <Field
                                        name="budget"
                                        type="input"
            ...
            <div
                className="h-20 relative bg-white fixed-bottom flex flex-row justify-center align-items-center gap-11 sm:gap-14 md:gap-16 lg:gap-20">
