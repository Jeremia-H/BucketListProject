...
function MapPage() {
    ...
    return (
        ...
        <div className="w-full relative flex flex-col h-screen bg-customBg">
            <button className="absolute top-2 z-50 right-3 md:right-4  bg-customPurple p-2 rounded-xl hover:scale-105"
                    onClick={logOut}>
                <CgLogOut className="size-4 lg:size-5  text-white"></CgLogOut>
            </button>
            <div className="flex-1 flex flex-col">
                <MapContainer
                    center={[50.883, 8.016]} // Initial coordinates [latitude, longitude]
                    zoom={6}                 // Initial zoom level
                    style={{ height: '100vh', width: '100%' }}
                    className="z-1"// Fullscreen map
                >
                    <TileLayer
            ...
            <div
                ...
                <button className="">
                    <FaMapMarkedAlt className="size-7 text-customPurple sm:size-8"></FaMapMarkedAlt>
                </button>
